...
class ResponsiveDataTable {
  ...
  renderPagination() {
    ...
    const nextButton = document.createElement("button"); nextButton.className = this.currentPage === pageCount ? disabledBtnClass : inactiveBtnClass; nextButton.textContent = "»"; nextButton.disabled = this.currentPage === pageCount; nextButton.onclick = () => this.changePage(pageCount === 0 ? 1 : this.currentPage + 1); pagination.appendChild(nextButton);
  }
