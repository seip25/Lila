...
async def home(request: Request): 
    response = render(request=request, template='index')  # English: Renders the 'index' template with  translations | Español: Renderiza la plantilla 'index' con traducciones 
    return response   
